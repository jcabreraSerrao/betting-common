...
type Polla struct {
	...
	PrizeFirstPercent  decimal.Decimal    `gorm:"column:prize_first_percent;type:decimal(5,2)" json:"prizeFirstPercent"`
	PrizeSecondPercent decimal.Decimal    `gorm:"column:prize_second_percent;type:decimal(5,2)" json:"prizeSecondPercent"`
	PrizeThirdPercent  decimal.Decimal    `gorm:"column:prize_third_percent;type:decimal(5,2)" json:"prizeThirdPercent"`
	Jackpot            decimal.Decimal    `gorm:"column:jackpot;type:decimal(18,8);default:0" json:"jackpot"`
